# Contributing to dendroNetwork

This outlines how to propose a change to dendroNetwork.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("RonaldVisser/dendroNetwork", fork = TRUE)`.
...
Please note that the dendroNetwork project is released with a [Code of
